...
# 3 "changeStackLimit.c" 2

# 3 "changeStackLimit.c"
int fun(int val)
{
...
int main()
{
 struct rlimit var;
 getrlimit(
# 13 "changeStackLimit.c" 3 4
          RLIMIT_STACK
# 13 "changeStackLimit.c"
                      ,&var);
 var.rlim_cur*=3;
 setrlimit(
# 15 "changeStackLimit.c" 3 4
          RLIMIT_STACK
# 15 "changeStackLimit.c"
                      ,&var);
 fun(1);
